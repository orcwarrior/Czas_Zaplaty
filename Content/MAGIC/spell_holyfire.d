...
func int Spell_Logic_HOLYFIRE	(var int manaInvested)
{
	//PrintDebugNpc		(PD_MAGIC,	"Spell_Logic_HOLYFIRE");

	Correct_ScrollMana(SPL_SENDCAST_HOLYFIRE,manaInvested);		
	if 	(manaInvested == 10)
	{	return SPL_NEXTLEVEL;		};
	
	if (manaInvested >= SPL_SENDCAST_HOLYFIRE) 
	{	Multicast();
		return SPL_SENDCAST;		};
