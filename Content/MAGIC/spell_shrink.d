...
func int Spell_Logic_Shrink		(var int manaInvested)
{
	...
	Correct_ScrollMana(SPL_SENDCAST_SHRINK,manaInvested);			
	if (C_NpcIsMonster(other) && (Npc_GetAivar(other,AIV_MM_ShrinkState)==0) )		// nur auf bisher ungeschrumpfte Monster!
	{
