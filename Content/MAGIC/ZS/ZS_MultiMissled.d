...
func int ZS_MultiMissled()
{
	Npc_PercDisable  	(other,	PERC_ASSESSDAMAGE		);
	//PrintDebugNpc		(PD_MAGIC,	"ZS_MultiMissled");

	Npc_PercEnable		(self, PERC_ASSESSSTOPMAGIC, B_StopMultiMissled);
...
func int ZS_MultiMissled_Loop ()
{	
	//PrintDebugNpc		(PD_MAGIC, "ZS_MultiMissled_Loop" );
...
func void ZS_MultiMissled_End()
{
	//PrintDebugNpc		(PD_MAGIC, "ZS_MultiMissled_End");
};
