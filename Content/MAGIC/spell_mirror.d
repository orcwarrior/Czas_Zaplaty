...
func int Spell_Logic_Mirror(var int manaInvested)
{
	//PrintDebugNpc		(PD_MAGIC,	"Spell_Logic_Mirror");

	Correct_ScrollMana(SPL_SENDCAST_Mirror,manaInvested);		
	if (manaInvested>= SPL_SENDCAST_Mirror)
	{
		add_mirror(self);
		return SPL_SENDCAST;
	};
