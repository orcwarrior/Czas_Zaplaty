instance ORG_807_Organisator (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_807;
};
...
FUNC VOID Rtn_NC1_807 ()
{
	TA_Guard		(00,00,08,00,"NC_KDW01_OUT");	
	TA_Guard	(08,00,00,00,"NC_KDW01_OUT");
};
FUNC VOID Rtn_NC2_807 ()
{
	TA_Sleep		(00,00,08,00,"NC_HUT14_IN");	
	TA_SitCampfire	(08,00,00,00,"NC_PLACE05");
};
