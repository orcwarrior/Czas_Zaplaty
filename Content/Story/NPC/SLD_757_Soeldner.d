instance SLD_757_Soeldner (Npc_Default)
{
	...
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_FMCstart_757;
...
FUNC VOID Rtn_NC1_757 ()
{
	TA_Guard	(01,00,13,00,"NC_PATH_PEASANT_OUTSIDE8_WASH");
	TA_Guard	(13,00,01,00,"NC_PATH_PEASANT_OUTSIDE8_WASH");
};


FUNC VOID Rtn_NC2_757 ()
{
	TA_GuardPalisade	(01,00,13,00,"FMC_PATH12");
	TA_GuardPalisade	(13,00,01,00,"FMC_PATH12");
};
...
FUNC VOID Rtn_NC3_757 ()
{
	TA_Guard	(01,00,13,00,"LOCATION_15_IN");
	TA_Guard	(13,00,01,00,"LOCATION_15_IN");
};
