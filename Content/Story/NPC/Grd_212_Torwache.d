instance GRD_212_Torwache (Npc_Default)
{
	...
	Npc_SetAivar(self,AIV_RESPAWN, 	 TRUE);
   ...
   CreateInvItem		(self,ItMw_1H_Sword_01);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_212;
};
...
FUNC VOID Rtn_TRAP_212 ()
{
	TA_HostileGuard	(06,00,21,00,"OCC_CELLAR_HALL");
	TA_HostileGuard	(21,00,06,00,"OCC_CELLAR_HALL");
};
