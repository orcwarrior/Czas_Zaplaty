instance ORG_804_Organisator (Npc_Default)
{
	...
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_804;
};
...
FUNC VOID Rtn_NC1_804 () //Wache: Durchgang zu Lares
{
	TA_Guard	(20,00,08,00,"NC_GUARD_MAGES_RIGHT");
	TA_Guard	(08,00,20,00,"NC_GUARD_MAGES_RIGHT");
};

FUNC VOID Rtn_NC2_804 () //Wache: Durchgang zu Lares
{
	TA_GuardPassage	(20,00,08,00,"NC_HUT23_OUT_GUARD");
	TA_GuardPassage	(08,00,20,00,"NC_HUT23_OUT_GUARD");
};
