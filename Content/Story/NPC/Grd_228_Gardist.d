instance GRD_228_Gardist (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_startclose_228;
};

FUNC VOID Rtn_Prestart_228 ()
{
	TA_Guard		(07,00,20,00,"OCR_NORTHGATE_VWHEEL");
	TA_Guard	(20,00,07,00,"OCR_NORTHGATE_VWHEEL");
};
FUNC VOID Rtn_startclose_228 ()
{
	TA_GuardWheelClosed		(07,00,20,00,"OCR_NORTHGATE_VWHEEL");
	TA_GuardWheelClosed		(20,00,07,00,"OCR_NORTHGATE_VWHEEL");
};
FUNC VOID Rtn_ocalarm_228 ()
{
	TA_DRUNK		(07,00,20,00,"OCR_NORTHGATE_RAMP_ATOP");
	TA_DRUNK		(20,00,07,00,"OCR_NORTHGATE_RAMP_ATOP");
};
