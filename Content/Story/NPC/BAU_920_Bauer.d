instance BAU_920_Bauer (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_920;
};
...
FUNC VOID Rtn_NC1_920 ()
{
	Ta_SitCampfire	(20,35,08,35,"NC_PATH_PEASANT_OUTSIDE4");	
	Ta_SitCampfire		(08,35,20,35,"NC_PATH_PEASANT_OUTSIDE4");
};


FUNC VOID Rtn_NC2_920 ()
{
	TA_Sleep		(20,45,07,45,"NC_PATH_PEASANT");
	TA_PickRice		(07,45,20,45,"NC_PATH54");
};
