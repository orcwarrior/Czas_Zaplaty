instance ORG_815_Organisator (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_815;
};
...
FUNC VOID Rtn_NC1_815 ()
{
	TA_PracticeSword			(00,00,08,00,"NC_PLACE02");
	TA_PracticeSword		(08,00,00,00,"NC_PLACE02");
};


FUNC VOID Rtn_NC2_815 ()
{
	TA_Sleep			(00,00,08,00,"NC_HUT29_IN");
	TA_Smalltalk		(08,00,00,00,"NC_PATH18");
};
