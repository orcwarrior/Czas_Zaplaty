...
//	CreateInvItem (self,ItMiHarp);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_Concert_390;
...
//	CreateInvItem (self,ItMiDrumstick);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_391;
...
//	CreateInvItem (self,ItMiCellobow);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_392;
...
//	CreateInvItem (self,ItMiLuteIE);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_393;
...
//	CreateInvItem (self,ItMiYellowpipe);
	...
	Npc_SetTalentSkill	(self,NPC_TALENT_1H,1);
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_394;
...
instance InExtremo_Lutter(Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_395;
...
//	CreateInvItem (self,ItMiBluepipe);
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_396;
...
instance IE_397_Announcer(Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_announce_397;
...
instance Charlotte (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_announce_398;
};
...
instance IEFan1 (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_399;
};
...
instance IEFan2 (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_400;
};
...
instance IEFan3 (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_401;
	};
...
instance IEFan4 (Npc_Default)
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_concert_402;
	};
