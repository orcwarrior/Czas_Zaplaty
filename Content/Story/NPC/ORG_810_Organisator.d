...
// hat den mittleren Organistor-Dress und Bogen3,weil er Attentäter ist
{
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_810;
};

FUNC VOID Rtn_start_810 ()
{
	TA_Sleep		(23,30,07,30,"lada");
	TA_StandAround	(07,30,23,30,"parter");
};

FUNC VOID Rtn_NC1_810 ()
{
	TA_StandAround		(23,30,07,30,"NC_P01_TO_P02_06");
	TA_StandAround	(07,30,23,30,"NC_P01_TO_P02_06");
};

FUNC VOID Rtn_NC2_810 ()
{
	TA_Sleep		(23,30,07,30,"lada");
	TA_StandAround	(07,30,23,30,"parter");
};
