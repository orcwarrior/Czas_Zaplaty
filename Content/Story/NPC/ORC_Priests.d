...
//	CreateInvItem 		(self,Weltenspalter);
	...
	//------------- ai -------------
	/*B_InitNPCAddins(self);*/		daily_routine	=	Rtn_PreStart_2995;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;
	Npc_SetAivar(self,AIV_TALKBEFOREATTACK,  TRUE);
};
...
instance ORC_Priest_2 (Npc_Default)
{
	...
	//------------- ai -------------
	/*B_InitNPCAddins(self);*/		daily_routine	=	Rtn_PreStart_2996;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;	
	Npc_SetAivar(self,AIV_TALKBEFOREATTACK,TRUE);
};
...
instance ORC_Priest_3 (Npc_Default)
{
	...
	//------------- ai -------------
	/*B_InitNPCAddins(self);*/		daily_routine	=	Rtn_PreStart_2997;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;
	Npc_SetAivar(self,AIV_TALKBEFOREATTACK,TRUE);
};
...
instance ORC_Priest_4 (Npc_Default)
{
	...
	//------------- ai -------------
	/*B_InitNPCAddins(self);*/		daily_routine 	=	Rtn_PreStart_2998;
	senses		  	=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	senses_range  	=	1000;
	fight_tactic	=	FAI_HUMAN_MAGE;
	Npc_SetAivar(self,AIV_TALKBEFOREATTACK,TRUE);
...
instance ORC_Priest_5 (Npc_Default)
{
	...
	//------------- ai -------------
	/*B_InitNPCAddins(self);*/		daily_routine	=	Rtn_PreStart_2999;
	senses			=	SENSE_SEE|SENSE_HEAR|SENSE_SMELL;
	fight_tactic	=	FAI_HUMAN_MAGE;
