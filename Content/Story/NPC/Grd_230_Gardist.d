...
{                
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_230;
};
...
FUNC VOID Rtn_HS_230 ()
{
	TA_MIS_GuardHeadshoot		(07,00,20,00,"OCC_MAINGATE_VWHEEL");
	TA_MIS_GuardHeadshoot		(20,00,07,00,"OCC_MAINGATE_VWHEEL");
};
...
{
	TA_GuardWheelOpen		(07,00,20,00,"OCC_MAINGATE_VWHEEL");
	TA_GuardWheelOpen		(20,00,07,00,"OCC_MAINGATE_VWHEEL");
};
