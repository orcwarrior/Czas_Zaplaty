instance EBR_105_Raven (Npc_Default)
{
   ...
   B_Scale (self); 
	...
	//-------- inventory --------                                    
	CreateInvItem(self,Rabenrecht);
	CreateInvItem(self,ItFo_Potion_Health_03);

	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = rtn_PreStart_105;
};
...
FUNC VOID Rtn_EN_105 ()
{
	TA_Guard		(07,00,20,00,"NC_EN_MAINPATH_05");
	TA_Guard		(20,00,07,00,"NC_EN_MAINPATH_05");
};

FUNC VOID Rtn_Hidden_105 ()
{
	TA_Guard		(07,00,20,00,"WP_INTRO_WI01");
	TA_Guard		(20,00,07,00,"WP_INTRO_WI01");
};