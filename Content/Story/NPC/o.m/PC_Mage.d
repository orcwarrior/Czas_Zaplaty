INSTANCE PC_Mage(NPC_DEFAULT)
{
	...
	attribute[ATR_MANA_MAX]	 	=		550;
	attribute[ATR_MANA] 		=		550;
...
{	
   TA_Stand	(03,20,05,30,"MAG_PRA");
   TA_Stand	(05,31,02,19,"MAG_PRA");
};
...
{
   TA_Stand(00,00,12,00,"HC_SAWHUT_SIT1");
	TA_Stand(12,00,00,00,"HC_SAWHUT_SIT1");
};
...
Func Void Rtn_Alarm_2 ()
{
	TA_KillingGRDs(08,00,07,59,"OR_STAIRS1_04"); 
};