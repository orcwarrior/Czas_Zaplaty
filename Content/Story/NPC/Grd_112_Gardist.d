instance Grd_112_Gardist (Npc_Default)
{
	//-------- primary data --------
	//Chase Hero
	name 		=	NAME_Gardist;
	...
	//-------------Daily Routine-------------
	/*B_InitNPCAddins(self);*/		daily_routine = Rtn_start_112;
};

FUNC VOID Rtn_start_112 ()
{
    TA_MIS_GuardHeadshoot	(00,30,20,00,"OCR_HIDE_2");	//
    TA_MIS_GuardHeadshoot	(20,00,07,00,"OCR_HIDE_2"); //
};


FUNC VOID Rtn_DEAD_112 ()
{
