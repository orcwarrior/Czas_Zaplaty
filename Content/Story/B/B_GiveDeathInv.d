func void B_GiveDeathInv ()
{
	...
	if (Knows_GetTeeth == TRUE)
	{
		...
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_YOUNGALIGATOR)		{	CreateInvItems(self,ItAt_AligatTeeth,		2);	};
		...
		// Ork ma chyba obsesje na punkcie orkow...... too many orc IDs
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORC)					{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCSCOUT)				{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCSCOUTGYD)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCSHAMAN)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCSLAVE)				{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCDANCE)				{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCDRUM)				{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCWARRIOR1)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCWARRIOR2)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCWARRIOR3)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCWARRIOR4)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCELITE)				{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_ORCGENERAL)			{	CreateInvItems(self,ItAt_OrcTeeth,			2);	};
		// 
	...
	if (Knows_GetClaws == TRUE)
	{
		...
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_YOUNGALIGATOR)		{	CreateInvItems(self,ItAt_AligatClaws,		4);	};
	...
	if (Knows_GetHide == TRUE)
	{
		...
		if (Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_YOUNGALIGATOR)		{	CreateInvItems(self,ItAt_AligatSkin,		1);	};
	...
	if (Knows_GetTongue== TRUE)
	{
		...
		||  Npc_GetAivar(self,AIV_MM_REAL_ID)==ID_DRACONIANSOLDIER
