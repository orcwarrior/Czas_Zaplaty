...
//SAy Gold
	...
	var string Gold10;	 //10 bry³ek rudy.  
	var string Gold50;	 //50 bry³ek rudy.  	
	var string Gold100;	 //100 bry³ek rudy. 	
	var string Gold150;	 //150 bry³ek rudy. 	
	var string Gold200;	 //200 bry³ek rudy. 	
	var string Gold250;	 //250 bry³ek rudy. 	
	var string Gold300;	 //300 bry³ek rudy. 	
	var string Gold350;	 //350 bry³ek rudy. 	
	var string Gold400;	 //400 bry³ek rudy. 	
	var string Gold450;	 //450 bry³ek rudy. 	
	var string Gold500;	 //500 bry³ek rudy. 	
	var string Gold550;	 //550 bry³ek rudy. 	
	var string Gold600;	 //800 bry³ek rudy. 	
	var string Gold650;	 //850 bry³ek rudy. 	
	var string Gold700;	 //700 bry³ek rudy. 	
	var string Gold750;	 //750 bry³ek rudy. 	
	var string Gold800;	 //800 bry³ek rudy. 	
	var string Gold850;	 //850 bry³ek rudy. 	
	var string Gold900;	 //900 bry³ek rudy. 	
	var string Gold950;	 //950 bry³ek rudy. 		
	var string Gold1000; //1000 bry³ek rudy.					
...
instance SVM_12	(C_SVM)		//Bazaar-Händler		Nach außen freundlich,jovial,Innen hinterhältig, raffgierig
{
	...
	//only cavalorn needs say gold
	Gold10	    	=	"SVM_12_Gold10"  ;//10 bry³ek rudy.
	Gold50	  		=	"SVM_12_Gold50"  ;//50 bry³ek rudy.
	Gold100	    	=	"SVM_12_Gold100" ;//100 bry³ek rudy.
	Gold150	    	=	"SVM_12_Gold150" ;//150 bry³ek rudy.
	Gold200	    	=	"SVM_12_Gold200" ;//200 bry³ek rudy.
	Gold250	    	=	"SVM_12_Gold250" ;//250 bry³ek rudy.
	Gold300	    	=	"SVM_12_Gold300" ;//300 bry³ek rudy.
	Gold350	    	=	"SVM_12_Gold350" ;//350 bry³ek rudy.
	Gold400	    	=	"SVM_12_Gold400" ;//400 bry³ek rudy.
	Gold450	    	=	"SVM_12_Gold450" ;//450 bry³ek rudy.
	Gold500	    	=	"SVM_12_Gold500" ;//500 bry³ek rudy.
	Gold550	    	=	"SVM_12_Gold550" ;//550 bry³ek rudy.
	Gold600	    	=	"SVM_12_Gold600" ;//800 bry³ek rudy.
	Gold650	    	=	"SVM_12_Gold650" ;//850 bry³ek rudy.
	Gold700	    	=	"SVM_12_Gold700" ;//700 bry³ek rudy.
	Gold750	    	=	"SVM_12_Gold750" ;//750 bry³ek rudy.
	Gold800	    	=	"SVM_12_Gold800" ;//800 bry³ek rudy.
	Gold850	    	=	"SVM_12_Gold850" ;//850 bry³ek rudy.
	Gold900	    	=	"SVM_12_Gold900" ;//900 bry³ek rudy.
	Gold950	  		=	"SVM_12_Gold950" ;//950 bry³ek rudy.
	Gold1000  		=	"SVM_12_Gold1000";//1000 bry³ek rudy.
};
...
instance SVM_16 (C_SVM)
{
	...
	WatchYourAim				=	"SVM_16_WeaponDown"				;//Od³ó¿ broñ!
	WatchYourAimAngry			=	"SVM_16_ISaidWeaponDown"		;//Od³o¿ysz w koñcu tê cholern¹ broñ?!
	WhatAreYouDoing				=	"SVM_16_WhatAreYouDoing"			;//Hej, uwa¿aj! Jeszcze raz i ci przy³o¿ê!
	LetsForgetOurLittleFight	=	"SVM_16_NextTimeYoureInForIt"	;//Zobaczymy nastêpnym razem...
	Strange						="SVM_16_WhatWasThat"				;//Co TO by³o!?
	DieMonster					=	"SVM_16_DieStupidBeast"				;//Tu nie ma miejsca dla bestii!
	DieMortalEnemy				=	"SVM_16_DieEnemy"					;//Wybi³a twoja godzina!
	NowWait						=	"BAB_Ambient_A3"						;//
	YouStillNotHaveEnough		=	"SVM_16_LookingForTroubleAgain"	;//Ci¹gle ci ma³o?!
	YouAskedForIt				=	"SVM_16_YouAskedForIt"				;//Sam tego chcia³eœ!
	NowWaitIntruder				=	"SVM_16_GetUpAndBeGone"				;//A teraz zabieraj siê st¹d!
	IWillTeachYouRespectForForeignProperty	=	"SVM_16_DirtyThief"					;//Parszywy z³odziej! Czekaj tylko...
	DirtyThief					=	"SVM_16_DirtyThief"					;//Parszywy z³odziej! Czekaj tylko...
	YouAttackedMyCharge			="SVM_16_ATTACK_CRIME"    			;//Jesteœ brutalnym oprychem. Nie chcê mieæ z tob¹ nic wspólnego.
	YouKilledOneOfUs			="SVM_16_ATTACK_CRIME"    			;//Jesteœ brutalnym oprychem. Nie chcê mieæ z tob¹ nic wspólnego.
	Dead						="SVM_16_Dead"						;//Aaaarhhh!
	Aargh_1						="SVM_16_Aargh_1"					;//Aargh
	Aargh_2						="SVM_16_Aargh_2"					;//Aargh
	Aargh_3						="SVM_16_Aargh_3"					;//Aargh
	Berzerk						="SVM_16_Aargh_3"					;//Aargh
	YoullBeSorryForThis			=	"SVM_16_NextTimeYoureInForIt"	;//Zobaczymy nastêpnym razem...
	YesYes						=	"SVM_16_SpareMe"						;//Nie rób mi krzywdy!
	ShitWhatAMonster			= 	"SVM_16_RunAway"						;//Wynoszê siê st¹d!
	Help						=	"SVM_16_Help"					;//Pomocy!
	WeWillMeetAgain				= 	"SVM_16_IGetYouStill"				;//W koñcu i tak ciê dorwê!
	NeverTryThatAgain			=	"SVM_16_GetOutOfHere"			;//Wynoœ siê st¹d!
	ITakeYourWeapon				=	"SVM_16_ITakeYourWeapon"			;//Lepiej zaopiekujê siê twoj¹ broni¹.
	ITookYourOre				=	"BAB_Ambient_A3"						;//
	ShitNoOre					=	"BAB_Ambient_A3"						;//
	...
	YouViolatedForbiddenTerritory =	"SVM_16_WhyAreYouInHere"		;//Czego tutaj szukasz? OdejdŸ!
	YouWannaFoolMe				= 	"SVM_16_NOTNOW"					;//Zostaw mnie w spokoju!
	WhatsThisSupposedToBe		=	"SVM_16_YouDisturbedMySlumber"	;//Co jest?
	WhyAreYouInHere				=	"SVM_16_WhyAreYouInHere"		;//Czego tutaj szukasz? OdejdŸ!
	WhatDidYouInThere			=	"SVM_16_GetOutOfHere"			;//Wynoœ siê st¹d!
	WiseMove					=	"SVM_16_WiseMove"				;//M¹dra decyzja...
	Alarm						=	"SVM_16_Alarm"					;//ALARM!
	IntruderAlert				=	"SVM_16_Guards"					;//STRA¯!
	BehindYou					=	"SVM_16_Ooh02"					;//Uwa¿aj!
	TheresAFight				=	"SVM_16_TheresAFight"			;//Aach, walka...
	HeyHeyHey					=	"SVM_16_CheerFriend02"			;//Poka¿ mu!
	CheerFight					=	"SVM_16_GoodVictory"			;//Pokaza³eœ mu, kto tu rz¹dzi!
	CheerFriend					=	"SVM_16_CheerFriend01"			;//Rozwal go!
	Ooh							=	"SVM_16_Ooh03"					;//Och! To musia³o boleæ!
	YeahWellDone				=	"SVM_16_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	
	RunCoward					=	"SVM_16_RunCoward"				;//Stój, tchórzu!
	HeDefeatedHim				=	"SVM_16_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	HeDeservedIt				=	"SVM_16_Ooh03"					;//Och! To musia³o boleæ!
	HeKilledHim					=	"SVM_16_YouMurderer"					;//Morderca!
	ItWasAGoodFight				=	"SVM_16_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	Awake						= 	"SVM_16_Awake"					;//(ziewniêcie)
	FriendlyGreetings			=	"BAB_Ambient_A3"						;//
	ALGreetings					=	"BAB_Ambient_A3"						;//
	MageGreetings				=	"BAB_Ambient_A3"						;//
	SectGreetings				=	"BAB_Ambient_A3"						;//
	ThereHeIs					=	"BAB_Ambient_A3"						;//
	NoLearnNoPoints				= 	"SVM_16_NoLearnNoPoints"				;//Wróæ, kiedy nabierzesz trochê wiêcej doœwiadczenia.
	NoLearnOverMax				= 	"SVM_16_NoLearnOverPersonalMAX"			;//Wymagasz ode mnie wiêcej, ni¿ mogê ciê nauczyæ.
	NoLearnYouAlreadyKnow		= 	"SVM_16_YouLearnedSomething"			;//Widzisz, ju¿ siê czegoœ nauczy³eœ...
	NoLearnYoureBetter			= 	"SVM_16_NoLearnYoureBetter"				;//Nie mogê ciê ju¿ niczego nauczyæ. Jesteœ ju¿ zbyt dobry.
	HeyYou						=	"BAB_Ambient_A3"						;//
	NotNow						= 	"SVM_16_NOTNOW"							;//Zostaw mnie w spokoju!
	WhatDoYouWant				=	"BAB_Ambient_A3"						;//
	ISaidWhatDoYouWant			=	"BAB_Ambient_A3"						;//
	MakeWay						=	"BAB_Ambient_A3"						;//
	OutOfMyWay					= 	"SVM_16_YesGoOutOfHere"					;//No, zabieraj siê!
	YouDeafOrWhat				=	"SVM_16_GetOutOfHere"					;//Wynoœ siê st¹d!
	LookingForTroubleAgain		= 	"SVM_16_NOTNOW"							;//Zostaw mnie w spokoju!
	LookAway					=	"SVM_16_SpareMe"						;//Nie rób mi krzywdy!
	OkayKeepIt					=	"BAB_Ambient_A3"						;//
	WhatsThat					= 	"SVM_16_WhatWasThat"					;//Co TO by³o!?
	ThatsMyWeapon				=	"BAB_Ambient_A3"						;//
	GiveItToMe					=	"SVM_16_DirtyThief"						;//Parszywy z³odziej! Czekaj tylko...
	YouCanKeeptheCrap			=	"BAB_Ambient_A3"						;//
	TheyKilledMyFriend			=	"BAB_Ambient_A3"						;//
	YouDisturbedMySlumber		=	"SVM_16_YouDisturbedMySlumber"	;//Co jest?
	SuckerGotSome				=	"BAB_Ambient_A3"						;//
	GetThingsRight				=	"BAB_Ambient_A3"						;//
	YouDefeatedMeWell			=	"SVM_16_SpareMe"						;//Nie rób mi krzywdy!
	// -----------------------------------------------------------------------------------------------------------------------
...
instance SVM_18(C_SVM)
{
	...
	WatchYourAim				=	"SVM_17_WeaponDown"				;//Od³ó¿ broñ!
	WatchYourAimAngry			=	"SVM_17_ISaidWeaponDown"		;//Od³o¿ysz w koñcu tê cholern¹ broñ?!
	WhatAreYouDoing				=	"SVM_17_WhatAreYouDoing"			;//Hej, uwa¿aj! Jeszcze raz i ci przy³o¿ê!
	LetsForgetOurLittleFight	=	"SVM_17_NextTimeYoureInForIt"	;//Zobaczymy nastêpnym razem...
	Strange						="SVM_17_WhatWasThat"				;//Co TO by³o!?
	DieMonster					=	"SVM_17_DieStupidBeast"				;//Tu nie ma miejsca dla bestii!
	DieMortalEnemy				=	"SVM_17_DieEnemy"					;//Wybi³a twoja godzina!
	NowWait						=	"BAB_Ambient_A3"						;//
	YouStillNotHaveEnough		=	"SVM_17_LookingForTroubleAgain"	;//Ci¹gle ci ma³o?!
	YouAskedForIt				=	"SVM_17_YouAskedForIt"				;//Sam tego chcia³eœ!
	NowWaitIntruder				=	"SVM_17_GetUpAndBeGone"				;//A teraz zabieraj siê st¹d!
	IWillTeachYouRespectForForeignProperty	=	"SVM_17_DirtyThief"					;//Parszywy z³odziej! Czekaj tylko...
	DirtyThief					=	"SVM_17_DirtyThief"					;//Parszywy z³odziej! Czekaj tylko...
	YouAttackedMyCharge			="SVM_17_ATTACK_CRIME"    			;//Jesteœ brutalnym oprychem. Nie chcê mieæ z tob¹ nic wspólnego.
	YouKilledOneOfUs			="SVM_17_ATTACK_CRIME"    			;//Jesteœ brutalnym oprychem. Nie chcê mieæ z tob¹ nic wspólnego.
	Dead						="SVM_17_Dead"						;//Aaaarhhh!
	Aargh_1						="SVM_17_Aargh_1"					;//Aargh
	Aargh_2						="SVM_17_Aargh_2"					;//Aargh
	Aargh_3						="SVM_17_Aargh_3"					;//Aargh
	Berzerk						="SVM_17_Aargh_3"					;//Aargh
	YoullBeSorryForThis			=	"SVM_17_NextTimeYoureInForIt"	;//Zobaczymy nastêpnym razem...
	YesYes						=	"SVM_17_SpareMe"						;//Nie rób mi krzywdy!
	ShitWhatAMonster			= 	"SVM_17_RunAway"						;//Wynoszê siê st¹d!
	Help						=	"SVM_17_Help"					;//Pomocy!
	WeWillMeetAgain				= 	"SVM_17_IGetYouStill"				;//W koñcu i tak ciê dorwê!
	NeverTryThatAgain			=	"SVM_17_GetOutOfHere"			;//Wynoœ siê st¹d!
	...
	YouViolatedForbiddenTerritory =	"SVM_17_WhyAreYouInHere"		;//Czego tutaj szukasz? OdejdŸ!
	YouWannaFoolMe				= 	"SVM_17_NOTNOW"					;//Zostaw mnie w spokoju!
	WhatsThisSupposedToBe		=	"SVM_17_YouDisturbedMySlumber"	;//Co jest?
	WhyAreYouInHere				=	"SVM_17_WhyAreYouInHere"		;//Czego tutaj szukasz? OdejdŸ!
	WhatDidYouInThere			=	"SVM_17_GetOutOfHere"			;//Wynoœ siê st¹d!
	WiseMove					=	"SVM_17_WiseMove"				;//M¹dra decyzja...
	Alarm						=	"SVM_17_Alarm"					;//ALARM!
	IntruderAlert				=	"SVM_17_Guards"					;//STRA¯!
	BehindYou					=	"SVM_17_Ooh02"					;//Uwa¿aj!
	TheresAFight				=	"SVM_17_TheresAFight"			;//Aach, walka...
	HeyHeyHey					=	"SVM_17_CheerFriend02"			;//Poka¿ mu!
	CheerFight					=	"SVM_17_GoodVictory"			;//Pokaza³eœ mu, kto tu rz¹dzi!
	CheerFriend					=	"SVM_17_CheerFriend01"			;//Rozwal go!
	Ooh							=	"SVM_17_Ooh03"					;//Och! To musia³o boleæ!
	YeahWellDone				=	"SVM_17_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	
	RunCoward					=	"SVM_17_RunCoward"				;//Stój, tchórzu!
	HeDefeatedHim				=	"SVM_17_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	HeDeservedIt				=	"SVM_17_Ooh03"					;//Och! To musia³o boleæ!
	HeKilledHim					=	"SVM_17_YouMurderer"					;//Morderca!
	ItWasAGoodFight				=	"SVM_17_OhMyGodHesDown"			;//Bogowie! Jak brutalnie...
	...
	NoLearnOverMax				= 	"SVM_17_NoLearnOverPersonalMAX"			;//Wymagasz ode mnie wiêcej, ni¿ mogê ciê nauczyæ.
	NoLearnYouAlreadyKnow		= 	"SVM_17_YouLearnedSomething"			;//Widzisz, ju¿ siê czegoœ nauczy³eœ...
	NoLearnYoureBetter			= 	"SVM_17_NoLearnYoureBetter"				;//Nie mogê ciê ju¿ niczego nauczyæ. Jesteœ ju¿ zbyt dobry.
	HeyYou						=	"BAB_Ambient_A3"						;//
	NotNow						= 	"SVM_17_NOTNOW"							;//Zostaw mnie w spokoju!
	WhatDoYouWant				=	"BAB_Ambient_A3"						;//
	ISaidWhatDoYouWant			=	"BAB_Ambient_A3"						;//
	MakeWay						=	"BAB_Ambient_A3"						;//
	OutOfMyWay					= 	"SVM_17_YesGoOutOfHere"					;//No, zabieraj siê!
	YouDeafOrWhat				=	"SVM_17_GetOutOfHere"					;//Wynoœ siê st¹d!
	LookingForTroubleAgain		= 	"SVM_17_NOTNOW"							;//Zostaw mnie w spokoju!
	LookAway					=	"SVM_17_SpareMe"						;//Nie rób mi krzywdy!
	OkayKeepIt					=	"BAB_Ambient_A3"						;//
	WhatsThat					= 	"SVM_17_WhatWasThat"					;//Co TO by³o!?
	ThatsMyWeapon				=	"BAB_Ambient_A3"						;//
	GiveItToMe					=	"SVM_17_DirtyThief"						;//Parszywy z³odziej! Czekaj tylko...
	YouCanKeeptheCrap			=	"BAB_Ambient_A3"						;//
	TheyKilledMyFriend			=	"BAB_Ambient_A3"						;//
	YouDisturbedMySlumber		=	"SVM_17_YouDisturbedMySlumber"	;//Co jest?
	SuckerGotSome				=	"BAB_Ambient_A3"						;//
	GetThingsRight				=	"BAB_Ambient_A3"						;//
	YouDefeatedMeWell			=	"SVM_17_SpareMe"						;//Nie rób mi krzywdy!
	// -----------------------------------------------------------------------------------------------------------------------
	...
	Smalltalk17					="SVM_17_Smalltalk17"				;//...nie mogê zajmowaæ siê wszystkim i wszystkimi...
