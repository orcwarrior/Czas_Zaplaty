...
{
	//PrintDebugInt			(PD_TA_FRAME,	"ZS_StandAround");
	...
	{
		//PrintDebugInt		(PD_TA_CHECK,	"...nicht auf FP!");
...
{
	//PrintDebugInt			(PD_TA_LOOP,	"ZS_StandAround_Loop");
	...
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_NONE)	
	{	
		//-------- ...im ALTEN LAGER --------
...
{
	//PrintDebugInt			(PD_TA_FRAME,	"ZS_StandAround_End");
