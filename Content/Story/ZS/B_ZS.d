...
const int	TA_IT_HAVEIMPORTANTSTATE	= 15;
...
func void B_EatSmall (VAR C_NPC self)
{
	...
	if ((Npc_GetStateTime(self)>=Npc_GetAivar(self,AIV_ITEMFREQ)) && (Hlp_Random(100) > 20))
	{
		AI_PlayAni (self,"T_FOOD_RANDOM_1"); 
		Npc_SetStateTime(self,0);
		
		Npc_SetAivar(self,AIV_ITEMFREQ,(Hlp_Random(5)+5));
	};	
};	
...
func void B_EatHuge (VAR C_NPC self)
{
	...
	if (Npc_GetStateTime(self)>=Npc_GetAivar(self,AIV_ITEMFREQ))
	{
...
func void B_DrinkBottle (VAR C_NPC self)
{
	...
	if ((Npc_GetStateTime(self)>=Npc_GetAivar(self,AIV_ITEMFREQ)) && (Hlp_Random(100) > 30))
	{
...
func void B_WipeMouth (VAR C_NPC self)
{
	...
	if ((Npc_GetStateTime(self)>=Npc_GetAivar(self,AIV_ITEMFREQ)) && (Hlp_Random(100) > 50))
	{
...
func void B_EatRice (VAR C_NPC self)
{
	...
	if ((Npc_GetStateTime(self)>=Npc_GetAivar(self,AIV_ITEMFREQ)) && Hlp_Random(1) == 1)
	{
...
{
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_APPLE)
	{
		B_EatSmall (self);	
	};
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_LOAF)
	{
		B_EatHuge (self);	
	};
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_CHEESE)
	{
		B_EatHuge (self);
	};
	if ((Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BEER)||(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BOOZE)||(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_WINE))
	{
		B_DrinkBottle (self);
	};
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_JOINT)
	{
		B_DrawJoint (self);
	};
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_MEAT)
	{
		B_EatMeat (self);
	};
	if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_RICE)
	{
		B_EatRice (self);
	};
	...
	if ((Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BEER)||(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BOOZE))
	{
		B_LookBottle (self);
	};
	if ((Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BEER)||(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BOOZE)||(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_WINE))
...
func void B_ChooseApple (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_APPLE);
	...
	Npc_SetAivar(self,AIV_ITEMFREQ,1);		
};
...
func void B_ChooseLoaf (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_LOAF);
...
func void B_ChooseCheese (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_CHEESE);
...
func void B_ChooseBeer (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_BEER);
...
func void B_ChooseMeat (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_MEAT);
...
func void B_ChooseSoup (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_SOUP);
...
func void B_ChooseRice (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_RICE);
...
func void B_ChooseJoint (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_JOINT);
...
func void B_ChooseBooze (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_BOOZE);
...
func void B_ChooseWine (VAR C_NPC self)
{
	...
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_WINE);
...
func void B_ResetIterator (VAR C_NPC self)
{
	...
	if (Npc_GetAivar(self,AIV_GUARDITERATOR) >= 5000)
	{
...
func void B_ClearItem (VAR C_NPC self)
{
	...
	if 		(Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_APPLE)	{	AI_UseItemToState(self,	ItFoApple,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_LOAF)	{	AI_UseItemToState(self,	ItFoLoaf,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_CHEESE){	AI_UseItemToState(self,	ItFoCheese,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BEER)	{	AI_UseItemToState(self, ItFoBeer,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_MEAT)	{	AI_UseItemToState(self, ItFoMutton,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_SOUP)	{	AI_UseItemToState(self, ItFoSoup,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_RICE)	{	AI_UseItemToState(self, ItFoRice,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_JOINT)	{	AI_UseItemToState(self, ItMiJoint_1,-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_BOOZE)	{	AI_UseItemToState(self, ItFoBooze,	-1);	}
	else if (Npc_GetAivar(self,AIV_ITEMSTATUS) == TA_IT_WINE)	{	AI_UseItemToState(self, ItFoWine,	-1);	};
	
	Npc_SetAivar(self,AIV_ITEMSTATUS,  TA_IT_NONE);
};
