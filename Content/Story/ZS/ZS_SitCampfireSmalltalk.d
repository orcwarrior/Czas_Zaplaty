func void ZS_SitCampfireSmalltalk()
{
	GuardPerception ();
...
func void ZS_SitCampfireSmalltalk_loop()
{
	...
	if (Wld_DetectNpc(self,-1,ZS_SitCampfireSmalltalk, -1)&& Npc_GetDistToNpc(self, other)<600)
	{
...
*/
	...
	else if (Npc_GetStateTime(self) >= 55 )
	{
	    ////PrintDebugNpc		(PD_TA_CHECK,	"... kein Gesprächspartner gefunden!");
	    
	    AI_StartState	(self, ZS_SitCampfireEat, 1, "");
	};
...
func void ZS_SitCampfireSmalltalk_end()
{
