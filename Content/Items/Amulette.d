...
{
	B_Hack_ChangeAttribute(self,ATR_DEXTERITY,20);
};
...
{
	B_Hack_ChangeAttribute(self,ATR_STRENGTH,20);
};
...
{
	B_Hack_ChangeAttribute(self,ATR_DEXTERITY,7 );
	B_Hack_ChangeAttribute(self,ATR_STRENGTH,7 );
};
...
INSTANCE  GRDAMULET(C_ITEM)
{
	...
	description		= "Amulet rozpoznawczy stra¿ników";
	TEXT[0]			= "Wyryto na nim imiê Kali";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	TEXT[5]			= NAME_Value;
	COUNT[5]		= value;
...
INSTANCE  GRDAMULETDIEGO(C_ITEM)
{
	name 			=	NAME_Amulett;
	...
	description		= "Amulet rozpoznawczy stra¿ników";
	TEXT[0]			= "Wyryto na nim imiê Diego";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	TEXT[5]			= NAME_Value;
	COUNT[5]		= value;
...
INSTANCE  GRDAMULETERGOM(C_ITEM)
{
	name 			=	NAME_Amulett;
	...
	description		= "Amulet rozpoznawczy stra¿ników";
	TEXT[0]			= "Wyryto na nim imiê Ergom";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	TEXT[5]			= NAME_Value;
	COUNT[5]		= value;
...
INSTANCE  GRDAMULETGERFAN(C_ITEM)
{
	name 			=	NAME_Amulett;
	...
	description		= "Amulet rozpoznawczy stra¿ników";
	TEXT[0]			= "Wyryto na nim imiê Gerfam";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
	TEXT[5]			= NAME_Value;
	COUNT[5]		= value;
