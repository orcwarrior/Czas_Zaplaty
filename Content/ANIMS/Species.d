...
// Copied from G2 species
// (G2 climb more angled ledges was good decision IMO)
...
//PUPIL
	...
	SWIM_TIME		 		[GIL_PUP] = TIME_INFINITE;
	DIVE_TIME		 		[GIL_PUP] = 0;
	WATER_DEPTH_KNEE 		[GIL_PUP] = 40;
	WATER_DEPTH_CHEST		[GIL_PUP] = 70;

	STEP_HEIGHT		 		[GIL_PUP] = 60;
	JUMPLOW_HEIGHT	 		[GIL_PUP] = 100;
	JUMPMID_HEIGHT	 		[GIL_PUP] = 200;
                                
	SLIDE_ANGLE		 		[GIL_PUP] = 45;
	DISABLE_AUTOROLL 		[GIL_PUP] = 1;
	SURFACE_ALIGN	 		[GIL_PUP] = 1;
	TURN_SPEED				[GIL_PUP] = 130;
                               
	// Fallhöhe / Fallschaden  
	FALLDOWN_HEIGHT			[GIL_PUP] = 800;
	FALLDOWN_DAMAGE			[GIL_PUP] = 5;
                              
	// Kampf                  
	FIGHT_RANGE_BASE		[GIL_PUP] = 100;
	FIGHT_RANGE_FIST		[GIL_PUP] = 100;
	                            
	// Bluteffekte by KaiRo     
	BLOOD_EMITTER			[GIL_PUP] = "BFX_Preset1";
	BLOOD_TEXTURE			[GIL_PUP] = "BQM_Scavenger2.tga";
	BLOOD_FLOW				[GIL_PUP] = 1;
	BLOOD_AMOUNT			[GIL_PUP] = 5;
	BLOOD_MAX_DISTANCE		[GIL_PUP] = 80;

//PUPIL #2

	SWIM_TIME		 		[GIL_PUPIL] = TIME_INFINITE;
	DIVE_TIME		 		[GIL_PUPIL] = 0;
	WATER_DEPTH_KNEE 		[GIL_PUPIL] = 40;
	WATER_DEPTH_CHEST		[GIL_PUPIL] = 70;
                                    
	STEP_HEIGHT		 		[GIL_PUPIL] = 60;
	JUMPLOW_HEIGHT	 		[GIL_PUPIL] = 100;
	JUMPMID_HEIGHT	 		[GIL_PUPIL] = 200;
                                   
	SLIDE_ANGLE		 		[GIL_PUPIL] = 45;
	DISABLE_AUTOROLL 		[GIL_PUPIL] = 1;
	SURFACE_ALIGN	 		[GIL_PUPIL] = 1;
	TURN_SPEED				[GIL_PUPIL] = 130;
                                  
	// Fallhöhe / Fallschaden     
	FALLDOWN_HEIGHT			[GIL_PUPIL] = 800;
	FALLDOWN_DAMAGE			[GIL_PUPIL] = 5;
                                 
	// Kampf                     
	FIGHT_RANGE_BASE		[GIL_PUPIL] = 80;
	FIGHT_RANGE_FIST		[GIL_PUPIL] = 80;
	                              
	// Bluteffekte by KaiRo       
	BLOOD_EMITTER			[GIL_PUPIL] = "BFX_Preset1";
	BLOOD_TEXTURE			[GIL_PUPIL] = "BQM_Scavenger2.tga";
	BLOOD_FLOW				[GIL_PUPIL] = 1;
	BLOOD_AMOUNT			[GIL_PUPIL] = 5;
	BLOOD_MAX_DISTANCE		[GIL_PUPIL] = 80;
