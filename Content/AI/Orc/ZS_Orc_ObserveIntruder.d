...
func void ZS_OrcGuard_ObserveIntruder()
{
	...
	Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  0);
	Npc_SetAivar(self,AIV_WARNTARGET,  0);
...
func int ZS_OrcGuard_ObserveIntruder_Loop()
{
	...
	if ( Npc_GetDistToNpc( self, other ) > 1500)
	{
		Npc_SetAivar(self,AIV_WARNTARGET,  1);
	}
	else
	{
		Npc_SetAivar(self,AIV_WARNTARGET,  0);
...
// angry	
	...
	else if (( Npc_GetAttitude( self, other ) == ATT_ANGRY )&& (Npc_GetAivar(self,AIV_WARNTARGET) == FALSE))
	{		
		PrintDebugNpc( PD_ORC_FRAME, "ZS_OrcGuard_ObserveIntruder: ANGRY" );
		B_Orc_SmartTurn();
		if ( Npc_GetDistToNpc( self, other ) < 500  &&  
			 ( Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 1  ||  Npc_GetStateTime( self ) > 6 ) )
		{
			PrintDebugNpc( PD_ORC_FRAME, "ZS_OrcGuard_ObserveIntruder: ANGRY: Angriff 1" );
			B_Say( self, other, "$DIE" );
			AI_StartState( self, ZS_Orc_Attack, 1, "" );
		}
		else if ( Npc_GetDistToNpc( self, other ) < 1500  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 0 )
		{
			PrintDebugNpc( PD_ORC_FRAME, "ZS_OrcGuard_ObserveIntruder: ANGRY: Waffe ziehen" );
			Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  1);
			B_Say( self, other, "$LOOKINGFORTROUBLEEH" );
		}
		else if ( Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 1  &&  Npc_GetStateTime( self ) > 6 )
		{
...
// neutral
	...
	else if (( Npc_GetAttitude( self, other ) == ATT_NEUTRAL )	&& (Npc_GetAivar(self,AIV_WARNTARGET) == TRUE))
	{		
		PrintDebugNpc( PD_ORC_FRAME, "ZS_OrcGuard_ObserveIntruder: NEUTRAL" );
		B_Orc_SmartTurn();
		if ( Npc_GetDistToNpc( self, other ) < 300  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) > 0 )
		{
			if ( Npc_GetAivar(self,AIV_OBSERVEINTRUDER) != 2 )
			{
				Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  2);
				AI_Wait( self, 3 );
			}
		...
		else if ( Npc_GetDistToNpc( self, other ) < 500  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 0)
		{
			Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  1);
...
// friendly
	...
	{		
		...
		B_Orc_SmartTurn();
		if ( Npc_GetDistToNpc( self, other ) < 300  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) != 1 )
		{
			Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  1);
...
// angry
	...
	else if ( ( Npc_GetAttitude( self, other ) == ATT_ANGRY) && (Npc_GetAivar(self,AIV_WARNTARGET) == 0) )
	{		
		...
		else if ( (Npc_GetDistToNpc( self, other ) < 1500)  &&  (Npc_GetAivar(self,AIV_OBSERVEINTRUDER)==1) )
		{
...
// neutral	
	...
	else if ( (Npc_GetAttitude( self, other ) == ATT_NEUTRAL)	&& (Npc_GetAivar(self,AIV_WARNTARGET)==0) )
	{		
...
// angry
	...
	{		
		...
		else if ( Npc_GetDistToNpc( self, other ) < 400  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 0 )
		{
...
// neutral
	...
	{		
		...
		B_Orc_SmartTurn();
		if ( Npc_GetDistToNpc( self, other ) < 200  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) > 0 )
		{
			if ( Npc_GetAivar(self,AIV_OBSERVEINTRUDER) != 2 )
			{
				Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  2);
...
// neutral
	...
	{		
		...
		else if ( Npc_GetDistToNpc( self, other ) < 1000  &&  Npc_GetAivar(self,AIV_OBSERVEINTRUDER) == 0)
		{
			Npc_SetAivar(self,AIV_OBSERVEINTRUDER,  1);
