...
func void PrintGuild (var int channel, var int guild)
{
	...
	if (guild ==  GIL_HUN) { PrintDebugNpc   ( channel, "...Gilde: GIL_EBR");};
	if (guild ==  GIL_GRD) { PrintDebugNpc   ( channel, "...Gilde: GIL_GRD");};
	if (guild ==  GIL_RBL) { PrintDebugNpc   ( channel, "...Gilde: GIL_STT");};
	if (guild ==  GIL_MAG) { PrintDebugNpc   ( channel, "...Gilde: GIL_KDF");};
	if (guild ==  GIL_VLK) { PrintDebugNpc   ( channel, "...Gilde: GIL_VLK");};
	if (guild ==  GIL_KDW) { PrintDebugNpc   ( channel, "...Gilde: GIL_KDW");};
	if (guild ==  GIL_MTR) { PrintDebugNpc   ( channel, "...Gilde: GIL_SLD");};
	if (guild ==  GIL_PIR) { PrintDebugNpc   ( channel, "...Gilde: GIL_ORG");};
	if (guild ==  GIL_SLV) { PrintDebugNpc   ( channel, "...Gilde: GIL_BAU");};
	if (guild ==  GIL_SFB) { PrintDebugNpc   ( channel, "...Gilde: GIL_SFB");};
	                      
	if (guild ==  GIL_GUR) { PrintDebugNpc   ( channel, "...Gilde: GIL_GUR");};
	if (guild ==  GIL_PUP) { PrintDebugNpc   ( channel, "...Gilde: GIL_NOV");};
