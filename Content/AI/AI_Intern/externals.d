...
func VOID 	Mdl_SetModelFatness			(var C_NPC self, VAR  fatness) 	{};
...
// send a passive perception aus.Npc1 who sends NPC2 = = victim, perpetrator Npc3 = Offender/przestepca
...
//-------------------
//Returns Npc - portal owner where hero is now
//-IF hero is outside return notvaild
//-If portal is owner-free return notvaild
...
//-------------------
//Returns Guild of portal where player is in now
//-IF hero is outside return GIL_NONE
//-If space is guild-free return same as up
...
// - wenn der aktive Raum besitzerlos ist, dann ist der Rückgabe-Npc 'notValid'
//-------------------
//Returns Npc - portal of last portal-shift owner where hero is now
//-IF hero is outside return notvaild
//-If portal is owner-free return notvaild
...
// - wenn der aktive Raum gildenlos ist, dann wird GIL_NONE zurückgeliefert
//-------------------
//Returns Guild of portal of last portal-shift where player is in now
//-IF hero is outside return GIL_NONE
//-If space is guild-free return same as up
...
//-------------------
//Return true if hero is in Npc Room or his guild Room, else = FALSE
...
//Return true if hero before last portal shift was in npc Room or his guild Room, else = FALSE
...
func void B_LogSetTopicStatus( VAR STRING name, VAR INT status )
