...
// 										MASTER - AI
// *************************************************************************************
func void B_MM_NoReact ()
{
	//////PrintDebugNpc( PD_ZS_FRAME, "B_MM_NoReact" );

};
func void ZS_MM_GotoHeroAndTalk()
{
    //////PrintDebugNpc(PD_MST_FRAME,"ZS_MM_GotoHeroAndTalk");
    
	Npc_PercEnable		(self, PERC_ASSESSDAMAGE,	B_MM_ReactToDamage); 		
	Npc_PercEnable		(self, PERC_ASSESSMAGIC,	B_MM_NoReact);
	...
	if(	Npc_GetAivar(self,AIV_MM_TALKEDAFTERATTACK) != TRUE)
	{
...
func int ZS_MM_GotoHeroAndTalk_loop()
{
    //////PrintDebugNpc(PD_MST_LOOP,"ZS_MM_GotoHeroAndTalk_loop");
...
func void ZS_MM_GotoHeroAndTalk_end()
{
    //////PrintDebugNpc(PD_MST_FRAME,"ZS_MM_GotoHeroAndTalk_end");
    if(	Npc_GetAivar(self,AIV_MM_TALKEDAFTERATTACK) != TRUE)
	{
    B_ProcessInfos(self);
    }
...
func void ZS_MM_SleepingGuardian()
{
    //////PrintDebugNpc(PD_MST_FRAME,"ZS_MM_SleepingGuardian");
...
func int ZS_MM_SleepingGuardian_loop()
{
    //////PrintDebugNpc(PD_MST_LOOP,"ZS_MM_SleepingGuardian_loop");
    
	if	(Npc_GetDistToPlayer(self)< 600)
	{
...
func void ZS_MM_SleepingGuardian_end()
{
    //////PrintDebugNpc(PD_MST_FRAME,"ZS_MM_SleepingGuardian_end");
    AI_StartState				(self,ZS_MM_AllScheduler,1,"");
   self.start_aistate				= ZS_MM_AllScheduler;
...
func void B_MM_ObserveIntruder()
{
	...
	if (Npc_GetDistToNpc(self, other) <= Npc_GetAivar(self,AIV_MM_AttackRange))
	{
...
func void B_MM_AssessBody()
{
	...
	if (Npc_GetAivar(self,AIV_MM_TEMP_PRIO) == PRIO_PREY)
	{
...
func void ZS_MM_AssessEnemy()
{
	...
	if ((Npc_GetAivar(self,AIV_MM_Behaviour) == PASSIVE) || (Npc_GetAivar(self,AIV_MM_Behaviour) == PACKHUNTER))
	{
...
func int ZS_MM_AssessEnemy_loop()
{
	...
	if ((Npc_GetDistToNpc(self, other) <= Npc_GetAivar(self,AIV_MM_DrohRange)) && (Npc_GetDistToNpc(self, other) > Npc_GetAivar(self,AIV_MM_AttackRange))) 
	{
		if ((Npc_GetAivar(self,AIV_MM_Behaviour) == PASSIVE) || (Npc_GetAivar(self,AIV_MM_Behaviour) == PACKHUNTER))
		{
			if (Npc_GetStateTime (self) > Npc_GetAivar(self,AIV_MM_DrohTime))
			{	
				Npc_SetTarget	(self, other);
				Npc_ClearAIQueue(self);
				AI_StartState	(self, ZS_MM_Attack, 0, "");
...
func void ZS_MM_Attack ()
{
	...
	Npc_PercEnable	(self, PERC_ASSESSBODY, 	B_MM_AssessBody);
	Npc_PercEnable(Self,PERC_NPCCOMMAND,B_CHECKCOLLIDEDAMAGE_MONSTER);
	if (Npc_GetAivar(self,AIV_MM_PARTYMEMBER) == TRUE) //d.h. beschworenes Monster
	{	
	...
	if (Hlp_IsValidNpc(other) && !C_NpcIsDown(other)) 
	{
		...
		if (Npc_GetAivar(other,AIV_INVINCIBLE)==FALSE) // Nur NSCs angreifen, die NICHT im Talk sind
		{
			if(Npc_GetAivar(self,AIV_MM_REAL_ID) == ID_SKELETONRANGER)
			{
				...
				if(Npc_HasItems(self,readiedWeapon.munition)<2)
				{
					CreateInvItems(self,readiedWeapon.munition,3);
				};
...
func void B_MM_AssessWarn ()
{
	...
	if ( (Wld_GetGuildAttitude(self.guild,other.guild)==ATT_FRIENDLY) && (Npc_GetAivar(self,AIV_MM_Behaviour)==PACKHUNTER) )	
	{
...
func void ZS_MM_AllScheduler()
{
    //////PrintDebugNpc		(PD_MST_FRAME, "ZS_MM_AllScheduler");
     //////PrintDebugNpc		(PD_TA_FRAME, "ZS_MM_AllScheduler2");
	Npc_PercEnable(Self,PERC_NPCCOMMAND,B_CHECKCOLLIDEDAMAGE_MONSTER);
	...
	if (Wld_IsTime	(Npc_GetAivar(self,AIV_MM_SleepStart),00,Npc_GetAivar(self,AIV_MM_SleepEnd),00) || (Npc_GetAivar(self,AIV_MM_SleepStart) == OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_Rtn_Sleep, 1, "");
	}
	else if (Wld_IsTime	(Npc_GetAivar(self,AIV_MM_RestStart),00,Npc_GetAivar(self,AIV_MM_RestEnd),00) || (Npc_GetAivar(self,AIV_MM_RestStart) == OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_Rtn_Rest, 1, "");
	}
	else if (Wld_IsTime	(Npc_GetAivar(self,AIV_MM_RoamStart),00,Npc_GetAivar(self,AIV_MM_RoamEnd),00) || (Npc_GetAivar(self,AIV_MM_RoamStart) == OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_Rtn_Roam, 1, "");
	}
	else if (Wld_IsTime	(Npc_GetAivar(self,AIV_MM_EatGroundStart),00,Npc_GetAivar(self,AIV_MM_EatGroundEnd),00) || (Npc_GetAivar(self,AIV_MM_EatGroundStart) == OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_Rtn_EatGround, 1, "");
	}
	else if (Wld_IsTime	(Npc_GetAivar(self,AIV_MM_WuselStart),00,Npc_GetAivar(self,AIV_MM_WuselEnd),00) || (Npc_GetAivar(self,AIV_MM_WuselStart) == OnlyRoutine))
	{
...
{
    //////PrintDebugNpc		(PD_TA_FRAME, "ZS_MM_Rtn_Default");
...
{
    //////PrintDebugNpc		(PD_TA_LOOP, "ZS_MM_Rtn_Default_loop");
};
func void ZS_MM_Rtn_Default_end()
{
    //////PrintDebugNpc		(PD_TA_FRAME, "ZS_MM_Rtn_Default_end");
};
...
func void B_MM_AssessQuietSound_Sleep()
{
	...
	/*
	if (Npc_GetAivar(self,AIV_MM_CanLookWhileSleeping)==TRUE && Npc_GetAivar(self,AIV_MM_SchonmalGeglotzt)==FALSE)
	{
		AI_PlayAni	(self,"T_SLEEP_2_SLEEPLOOK");
		AI_LookAtNpc(self,other);
		AI_Wait		(self,2);
		AI_StopLookAt(self);
		Npc_SetAivar(self,AIV_MM_SchonmalGeglotzt,  TRUE);
	};
	*/	
	
	if (Npc_GetDistToNpc(self, other) <= Npc_GetAivar(self,AIV_MM_DrohRange))	//Drohrange > INTERMEDIAT bringt natürlich nix wegen QuietSound-Distanz
	{
...
func void ZS_MM_Rtn_Sleep()
{
	...
	//Npc_SetAivar(self,AIV_MM_SchonmalGeglotzt,  FALSE);
	AI_SetWalkmode 	(self, NPC_WALK);
...
func void ZS_MM_Rtn_Roam_loop()
{
	...
	if ((!Wld_IsTime (Npc_GetAivar(self,AIV_MM_RoamStart),00,Npc_GetAivar(self,AIV_MM_RoamEnd),00)) && (Npc_GetAivar(self,AIV_MM_RoamStart) != OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_AllScheduler, 1, "");
	};
...
func void ZS_MM_Rtn_Rest_Loop ()
{
	...
	if ((!Wld_IsTime	(Npc_GetAivar(self,AIV_MM_RestStart),00,Npc_GetAivar(self,AIV_MM_RestEnd),00)) && (Npc_GetAivar(self,AIV_MM_RestStart) != OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_AllScheduler, 1, "");
	};
...
func void ZS_MM_Rtn_EatGround_Loop ()
{
	...
	if ((!Wld_IsTime	(Npc_GetAivar(self,AIV_MM_EatGroundStart),00,Npc_GetAivar(self,AIV_MM_EatGroundEnd),00)) && (Npc_GetAivar(self,AIV_MM_EatGroundStart) != OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_AllScheduler, 1, "");
	};
};
...
func void ZS_MM_Rtn_Wusel_loop()
{
	...
	if ((!Wld_IsTime (Npc_GetAivar(self,AIV_MM_WuselStart),00,Npc_GetAivar(self,AIV_MM_WuselEnd),00)) && (Npc_GetAivar(self,AIV_MM_WuselStart) != OnlyRoutine))
	{
		AI_StartState (self, ZS_MM_AllScheduler, 1, "");
	};
...
func void ZS_MM_Summoned_End()
{
	...
	B_ChangeAttribute		(self,ATR_HITPOINTS, -self.attribute[ATR_HITPOINTS]);
};
