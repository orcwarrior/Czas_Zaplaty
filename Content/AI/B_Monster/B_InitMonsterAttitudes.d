...
func void B_InitMonsterAttitudes ()
{
	...
	B_SetGuildAttitude	(GIL_WARAN,			ATT_NEUTRAL,	GIL_TPL				);	
	B_SetGuildAttitude	(GIL_WARAN,			ATT_FRIENDLY,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_WARAN,			ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_WARAN,			ATT_NEUTRAL,	GIL_LURKER			);
 	B_SetGuildAttitude	(GIL_WARAN,			ATT_HOSTILE,	GIL_ORCSCOUT		);
	B_SetGuildAttitude	(GIL_WARAN,			ATT_HOSTILE,	GIL_ORCWARRIOR		);
	B_SetGuildAttitude	(GIL_WARAN,			ATT_HOSTILE,	GIL_ORCSHAMAN		);                                    	 	
	//-------- GOBBO --------
	B_SetGuildAttitude	(GIL_GOBBO,			ATT_HOSTILE,	GIL_SEPERATOR_HUM	);
	B_SetGuildAttitude	(GIL_GOBBO,			ATT_NEUTRAL,	GIL_TPL				);		
	B_SetGuildAttitude	(GIL_GOBBO,			ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_GOBBO,			ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_TROLL,			ATT_NEUTRAL,	GIL_TPL				);		
	B_SetGuildAttitude	(GIL_TROLL,			ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_TROLL,			ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_SNAPPER,			ATT_NEUTRAL,	GIL_TPL				);			
	B_SetGuildAttitude	(GIL_SNAPPER,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_SNAPPER,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_HOSTILE,	GIL_TPL				);				
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_MINECRAWLER,	ATT_HOSTILE,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_MEATBUG,		ATT_NEUTRAL,	GIL_TPL				);					
	B_SetGuildAttitude	(GIL_MEATBUG,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_MEATBUG,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_SCAVENGER,		ATT_NEUTRAL,	GIL_TPL				);						
	B_SetGuildAttitude	(GIL_SCAVENGER,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_SCAVENGER,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_DEMON,			ATT_NEUTRAL,	GIL_TPL				);							
	B_SetGuildAttitude	(GIL_DEMON,			ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_DEMON,			ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_WOLF,			ATT_NEUTRAL,	GIL_TPL				);								
	B_SetGuildAttitude	(GIL_WOLF,			ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_WOLF,			ATT_NEUTRAL,	GIL_PUPIL				);
	...
	//hero pupil
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_FRIENDLY,	GIL_SEPERATOR_HUM	);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_ANGRY,	GIL_GRD	);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_ANGRY,	GIL_DMB	);
	
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_TPL				);								
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_PUPIL				);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_GOBBO			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_TROLL			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_SNAPPER			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_MINECRAWLER		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_MEATBUG			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_SCAVENGER		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_DEMON			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_WOLF			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_SHADOWBEAST		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_BLOODFLY		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_SWAMPSHARK		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_ZOMBIE			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_UNDEADORC		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_SKELETON		);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_ORCDOG			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_MOLERAT			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_GOLEM			);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_LURKER			);
	...
	B_SetGuildAttitude	(GIL_SHADOWBEAST,			ATT_HOSTILE,	GIL_TPL		);									
	B_SetGuildAttitude	(GIL_SHADOWBEAST,	ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_SHADOWBEAST,	ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_BLOODFLY,		ATT_NEUTRAL,	GIL_TPL				);										
	B_SetGuildAttitude	(GIL_BLOODFLY,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_BLOODFLY,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_SWAMPSHARK,		ATT_NEUTRAL,	GIL_TPL				);											
	B_SetGuildAttitude	(GIL_SWAMPSHARK,	ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_SWAMPSHARK,	ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_ZOMBIE,		ATT_FRIENDLY,	GIL_TPL				);												
	B_SetGuildAttitude	(GIL_ZOMBIE,		ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_ZOMBIE,		ATT_FRIENDLY,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_FRIENDLY,	GIL_TPL				);													
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_UNDEADORC,		ATT_FRIENDLY,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_ORCDOG,		ATT_NEUTRAL,	GIL_TPL				);													
	B_SetGuildAttitude	(GIL_ORCDOG,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_ORCDOG,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_MOLERAT,		ATT_NEUTRAL,	GIL_TPL				);														
	B_SetGuildAttitude	(GIL_MOLERAT,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_MOLERAT,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_GOLEM,			ATT_HOSTILE,	GIL_TPL				);															
	B_SetGuildAttitude	(GIL_GOLEM,			ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_GOLEM,			ATT_HOSTILE,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_LURKER,		ATT_NEUTRAL,	GIL_TPL				);																
	B_SetGuildAttitude	(GIL_LURKER,		ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_LURKER,		ATT_NEUTRAL,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_SKELETON,		ATT_FRIENDLY,	GIL_TPL				);																	
	B_SetGuildAttitude	(GIL_SKELETON,		ATT_HOSTILE,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_SKELETON,		ATT_FRIENDLY,	GIL_PUPIL				);
	...
	B_SetGuildAttitude	(GIL_SEPERATOR_HUM,	ATT_FRIENDLY,	GIL_PUPIL				);
...
//HUMANs
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_TPL				);
	B_SetGuildAttitude	(GIL_PUPIL,			ATT_HOSTILE,	GIL_DMB				);
	B_SetGuildAttitude	(GIL_DMB,			ATT_HOSTILE,	GIL_PUPIL			);
	B_SetGuildAttitude	(GIL_TPL,			ATT_HOSTILE,	GIL_PUPIL			);		
	B_SetGuildAttitude	(GIL_GRD,			ATT_ANGRY,	GIL_PUPIL			);		
	
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_WARAN			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_PUPIL				);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_GOBBO			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_TROLL			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_SNAPPER			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_MINECRAWLER		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_MEATBUG			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_SCAVENGER		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_DEMON			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_WOLF			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_SHADOWBEAST		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_BLOODFLY		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_SWAMPSHARK		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_FRIENDLY,	GIL_ZOMBIE			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_FRIENDLY,	GIL_UNDEADORC		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_FRIENDLY,	GIL_SKELETON		);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_ORCDOG			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_MOLERAT			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_GOLEM			);
	B_SetGuildAttitude	(GIL_TPL,	ATT_NEUTRAL,	GIL_LURKER			);
	...
	B_SetGuildAttitude	(GIL_TPL,	ATT_HOSTILE,	GIL_ORCSLAVE		);	
		
	B_SetGuildAttitude	(GIL_SEPERATOR_HUM,	ATT_HOSTILE,	GIL_TPL				);																	
	...
	B_SetGuildAttitude	(GIL_RBL		,	ATT_FRIENDLY,	GIL_ORCSLAVE		);
