...
func void B_AssessItem ()
{
	...
	Npc_SetAivar(self,AIV_WANTEDITEM,  Hlp_GetInstanceId (item));
	
	
	///////////Testdaten/////////////////////////////
	var string	wanteditem; wanteditem = IntToString	(Npc_GetAivar(self,AIV_WANTEDITEM)); ////PrintDebugNpc (PD_ZS_FRAME,wanteditem);
	///////////Testdaten/////////////////////////////
	...
	C_StopLookAt	(self);
	Npc_SetAivar(self,AIV_WANTEDITEM,  0);
};
