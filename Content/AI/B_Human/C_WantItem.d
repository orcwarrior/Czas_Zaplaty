...
func int C_WantItem ()
{
	//PrintDebugInt( PD_ZS_DETAIL, "C_WantItem" );
	...
	if (Hlp_IsValidItem (item))
	{
		...
		{
			//PrintDebugInt(PD_ZS_DETAIL, "...'item' gehört NSC oder seiner Gilde -> JA!");
			return TRUE;
		};
	
		if 		(item.flags==ITEM_MISSION)
		{
			//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist Missionsgegenstand -> NEIN!");
			return FALSE;
		}
		else if	(
		...
		{
			//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist Rüstung und geht micht nichts an -> NEIN!");
			return FALSE;
		}
		else if	((item.mainflag==ITEM_KAT_RUNE)&&(!C_NpcIsMage(self)))
		{
			//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist eine Rune/Scroll und Nsc ist kein Magier -> NEIN!");
			return FALSE;
		}
		else if	(Hlp_IsItem(item,ItMiNugget))
		{
			//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist Erz -> JA!");
			return TRUE;
		}
		else
		{
			...
			{
				//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist wertvoll genug um interessant zu sein -> JA!");
				return TRUE;
			}
			else
			{
				//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist zu billig -> NEIN!");
				return FALSE;
			};
		};		
	}
	...
	{
		//PrintDebugInt( PD_ZS_DETAIL, "...'item' ist ungültig -> NEIN!");
		return FALSE;
	};
};