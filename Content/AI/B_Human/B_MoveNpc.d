func void B_MoveNpc ()
{
	...
	if (Npc_GetAivar(other,AIV_INVINCIBLE)==FALSE) //sonst ignorieren!	
	{	
		...
		if (Npc_GetAivar(other,AIV_INVINCIBLE))								// keine Reaktion, wenn der Blockierer gerade im Dialog ist 
		{
