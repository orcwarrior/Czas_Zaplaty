...
func void B_AssessFighter()
{
	...
	if ( C_NpcIsHuman(other) )
	{
		...
		else if (Npc_IsInState(self, ZS_GuardPassage))||((self.flags&NPC_FLAG_TALKONLY) != 0)
		{
		...
		if (Npc_GetAivar(other,AIV_INVINCIBLE) == TRUE)&&((self.flags&NPC_FLAG_TALKONLY) != 0) 
		{
			PrintDebugNpc	(PD_ZS_CHECK, "...Fighter ist im Dialog!" );//or wannabe...			
			return;
		};
