...
{
	/*
	if (Npc_GetAivar(other,AIV_DIDWAITTOCLEARROOM)	== 1)
	{
		Npc_SetAivar(other,AIV_DIDWAITTOCLEARROOM,	 0);
		AI_ContinueRoutine	( self);
	};
	*/
...
func void B_ClearRoomUseMob()
{
	...
	B_PrintDebug("B_ClearRoomUseMob");	
	...
	|| (Hlp_StrCmp(detMob, "CHESTBIG"))
	|| (Hlp_StrCmp(detMob, "CHESTSMALL")))
	&& (Hlp_StrCmp(detMob, "CHAIR") == FALSE)
	&& (Hlp_StrCmp(detMob, "BENCH") == FALSE)
	&& (Hlp_StrCmp(detMob, "BED") == FALSE)
	&& (Hlp_StrCmp(detMob, "BEDHIGH") == FALSE)
	&& (Hlp_StrCmp(detMob, "BEDLOW") == FALSE)
	&& (Hlp_StrCmp(detMob, "LADDER") == FALSE)
	&& (Hlp_StrCmp(detMob, "DOOR") == FALSE)
	&& (Hlp_StrCmp(detMob, "DOOR") == FALSE)
	{	
