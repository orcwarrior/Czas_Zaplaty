...
// 	if (Hlp_GetInstanceID (self) != Hlp_GetInstanceID (butch))
// 	{
		//-------- Npc was killed, don't defeated --------
		if((other.flags & NPC_FLAG_INSTANTDEATH) == NPC_FLAG_INSTANTDEATH)
		{
		...
		//-------- It was an personal business --------
		else if (C_GetAttackReason(victim) == AIV_AR_PERSONALAFFAIRS) 
		{
			////PrintDebugNpc		(PD_ZS_CHECK,	"...Sieg an Monster!");
			B_WhirlAround 		(self,	victim);
			return;
