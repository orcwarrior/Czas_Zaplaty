...
//			AI_TakeItem	( self, item);
//		};
//		if ( Npc_OwnedByGuild	(item, GIL_MTR))
//		{
...
//	};
//	if (Wld_DetectNpc	( self, -1, NOFUNC, GIL_MTR))
//	{
//		PrintDebug ( "GIL_MTR entdeckt");
//	};
//	
...
//	//Npc_MemoryEntryGuild	( self, NEWS_SOURCE_GOSSIP, other, NEWS_MURDER, GIL_MTR);
//	
...
//	B_ChangeAttribute	( self, ATR_HITPOINTS_MAX , +1);
//	if (!attribute	== self.attribute [ATR_HITPOINTS_MAX])
//	{
//		PrintDebug ("B_ChangeAttribute klappt");
//	};
//	
...
//	// *******************************************************************************************
//
//	if (Npc_GetTrueGuild ( self) == GIL_MTR )
//	{
...
//	};
//	
//	Wld_SetGuildAttitude ( GIL_MTR, ATT_ANGRY, GIL_KDW);
//	if ( Wld_GetGuildAttitude	(GIL_MTR, GIL_KDW) == ATT_ANGRY)
//	{
