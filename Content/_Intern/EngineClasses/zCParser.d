class zCParser {
    ...
    //zCPar_DataStack           datastack;              //Daten-Stack
        var int datastack_stack[/*zMAX_SYM_DATASTACK*/ 2048];     //0x0058 //leider sehr klein
...
const int zCPar_Symbol_bitfield_type        = ((1 <<  4) - 1) << 12;
const int zCPar_Symbol_bitfield_flags       = ((1 <<  6) - 1) << 16;
...
//Operatoren nehmen zwei Werte vom Datenstack und verrechnen sie. Das Ergebnis schieben sie auf den Stack.
...
//Befehle (Achtung: Operatoren sind auch Befehle!)
const int zPAR_TOK_RET			= 60; //0x3C    
const int zPAR_TOK_CALL			= 61; //0x3D    //+4 byte Callziel (Stack)
const int zPAR_TOK_CALLEXTERN	= 62; //0x3E    //+4 byte Symbol der External
const int zPAR_TOK_POPINT		= 63; //0x3F    //ungenutzt
const int zPAR_TOK_PUSHINT		= 64; //0x40    //+4 byte Konstante
const int zPAR_TOK_PUSHVAR		= 65; //0x41    //+4 byte Symbolindex
const int zPAR_TOK_PUSHSTR		= 66; //0x42    //ungenutzt
const int zPAR_TOK_PUSHINST		= 67; //0x43    //+4 byte Symbolindex
const int zPAR_TOK_PUSHINDEX	= 68; //0x44    //ungenutzt
const int zPAR_TOK_POPVAR		= 69; //0x45    //ungenutzt
const int zPAR_TOK_ASSIGNSTR	= 70; //0x46    
const int zPAR_TOK_ASSIGNSTRP	= 71; //0x47    
const int zPAR_TOK_ASSIGNFUNC	= 72; //0x48    
const int zPAR_TOK_ASSIGNFLOAT	= 73; //0x49    
const int zPAR_TOK_ASSIGNINST 	= 74; //0x4A    
const int zPAR_TOK_JUMP			= 75; //0x4B    //+4 byte Sprungziel
const int zPAR_TOK_JUMPF		= 76; //0x4C    //+4 byte Sprungziel

const int zPAR_TOK_SETINSTANCE	= 80; //0x50    //+4 byte Symbolindex
...
//Kann mit zPAR_TOK_PUSHVAR benutzt werden. In dem Fall wird noch ein Byte als Index gepopt.
